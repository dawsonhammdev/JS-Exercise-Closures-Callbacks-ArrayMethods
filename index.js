...
function getFullNames(runners) {
  ...
  runners.forEach(item => {
    name.push(item.last_name + ', ' + item.first_name)
  })
  return name
}
...
function firstNamesAllCaps(runners) {
  let nameFirst = runners.map((item) => {
...
function tallyUpDonations(runners) {
  let total = runners.reduce((accumulator, item) =>{
